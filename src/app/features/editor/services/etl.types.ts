...
export type TransformerType = 'reproject' | 'buffer' | 'topology_validator' | 'clip';
...
export const NODE_CATALOG: Array<{
...
}> = [
  {
    ...
    category: 'reader',
    defaultConfig: { format: 'geojson', inline: null },
  },
  {
    type: 'reader',
    label: 'Lecture Shapefile',
    category: 'reader',
    defaultConfig: { format: 'shapefile' },
  },
  {
    type: 'reader',
    label: 'Lecture GeoPackage',
    category: 'reader',
    defaultConfig: { format: 'geopackage', table: 'features' },
  },
  {
    type: 'reader',
    label: 'Lecture CSV',
    category: 'reader',
    defaultConfig: { format: 'csv', latField: 'lat', lonField: 'lon' },
  },
  {
    type: 'reader',
    label: 'Lecture JSON',
  ...
  },
  {
    ...
    category: 'reader',
    defaultConfig: { format: 'ifc' },
  },
  {
    type: 'reproject',
    label: 'Reprojection',
    category: 'transformer',
    defaultConfig: { source_srid: 4326, target_srid: 2154 },
  },
  {
    type: 'buffer',
    label: 'Tampon spatial',
    category: 'transformer',
    defaultConfig: { distance_m: 50 },
  },
  {
    type: 'topology_validator',
    label: 'Validateur topologie',
    category: 'transformer',
    defaultConfig: { heal: true },
  },
  {
    type: 'clip',
    label: 'Découpage',
  ...
  {
    type: 'writer',
    label: 'Sortie GeoJSON',
    category: 'writer',
    defaultConfig: { format: 'geojson' },
  },
];
