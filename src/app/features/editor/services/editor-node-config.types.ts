...
export const IO_FORMAT_OPTIONS: Array<{ value: IoFormat; label: string }> = [
	...
	{ value: "raster", label: "Raster (JPEG/GeoTIFF)" },
];

export const FEATURE_OPERATION_OPTIONS: Array<{
	value: FeatureOperation;
	label: string;
}> = [
...
export const TABLE_HANDLING_OPTIONS: Array<{
	value: TableHandling;
	label: string;
}> = [
...
export const USER_ATTRIBUTE_TYPE_OPTIONS: Array<{
	value: UserAttributeType;
	label: string;
}> = [
...
export const ATTRIBUTE_MODE_OPTIONS: Array<{
	value: AttributeDefinitionMode;
	label: string;
}> = [
...
export const SPATIAL_COLUMN_TYPE_OPTIONS: Array<{
	value: SpatialColumnType;
	label: string;
}> = [
	{ value: "geometry", label: "geometry" },
