  ...
  public: {
    ...
    Views: {
      executions: {
        ...
        Relationships: [
          {
            foreignKeyName: "execution_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "execution_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
      ...
      transformers: {
        ...
        Relationships: [
          {
            foreignKeyName: "transformer_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "transformer_project_id_fkey"
            columns: ["project_id"]
            isOneToOne: false
            referencedRelation: "projects"
            referencedColumns: ["id"]
